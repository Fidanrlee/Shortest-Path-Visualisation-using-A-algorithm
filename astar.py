...
class Spot:
    def __init__(self, row, col, width, total_rows, weight):
        self.weight = weight
        self.row = row
        self.col = col
        self.x = row * width
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if pygame.mouse.get_pressed()[0]: # LEFT
                ...
                elif spot != end and spot != start and river == True:
                    spot.make_river()

                elif spot != end and spot != start and green_area == True:
                    spot.make_green()
